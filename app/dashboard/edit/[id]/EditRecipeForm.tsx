      ...
      <div className="bg-dark-green text-beige py-10 px-6 md:px-10">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-beige/60 mt-1 font-inter">
            Update your family recipe details.
          </p>
        </div>
      </div>
            ...
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select id="recipe-category-select" name="category" defaultValue={recipe.category} className="input-abuela" required>
                ...
                <div>
                  ...
                  <select id="recipe-cuisine-select" name="cuisine" defaultValue={recipe.cuisine} className="input-abuela" required>
                    <option value="">Select…</option>
                    {CUISINES.map((c) => (
                      <option key={c} value={c}>{c}</option>
                    ))}
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <input id="recipe-prep-time-input" name="prepTime" type="number" defaultValue={recipe.prepTime} min={0} placeholder="15" className="input-abuela" />
                </div>
                <div>
                  <label className="block text-sm font-semibold text-dark-green mb-1.5 font-inter">
                    Cook Time (min)
                  </label>
                  <input id="recipe-cook-time-input" name="cookTime" type="number" defaultValue={recipe.cookTime} min={0} placeholder="30" className="input-abuela" />
                </div>
                <div>
                  <label className="block text-sm font-semibold text-dark-green mb-1.5 font-inter">
                    Servings
                  </label>
                  <input id="recipe-servings-input" name="servings" type="number" defaultValue={recipe.servings} min={1} placeholder="4" className="input-abuela" />
                </div>
              </div>
              <div>
                <label className="block text-sm font-semibold text-dark-green mb-1.5 font-inter">
                ...
                <div className="flex gap-3">
                  {DIFFICULTIES.map((d) => (
                    ...
                    >
                      <input type="radio" name="difficulty" defaultChecked={recipe.difficulty === d} value={d} className="accent-moss-green" />
                      {d}
                    </label>
                  ))}
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    name="lovedOneName"
                    type="text"
                    defaultValue={recipe.lovedOneName}
                ...
                <div>
                  ...
                  <input
                    ...
                    name="relationship"
                    type="text"
                    defaultValue={recipe.relationship}
          ...
          {currentStep === "settings" && (
            <div className="space-y-6">
              ...
              <div className="bg-cream-50 border border-[#d4d0a8] rounded-xl p-5 text-sm text-dark-green/60 font-inter">
                <p className="font-semibold text-dark-green mb-1">Ready to update?</p>
                <p>
